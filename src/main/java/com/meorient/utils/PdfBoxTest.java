...
public class PdfBoxTest extends PDFTextStripper {
    ...
    public PdfBoxTest(String uploadFileName) throws IOException {
//        super();
//        super.setSortByPosition(true);
    ...
    public void getCoordinate(InputStream in , Map<String, List<Company>> dataInfo) throws IOException {
        ...
        try {
            ...
            // File.separator + "usr" + File.separator + "fonts" + File.separator + "win" + File.separator + "simsunb.ttf"
...
//            drawTable(cs, bottomFourTableX,bottomTableY,bottomFourTableWidth,allTableheight2);
            ...
            for (Company company : companies) {
                ...
                if (StringUtils.defaultString(company.getMemo()).length() > 36) {
                    ...
                    writeText(cs, font, 9, topFivTableX + countMM(1), tempY + move2mm, company.getMemo());
                }
            }
